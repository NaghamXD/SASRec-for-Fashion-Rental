...
def save_to_csv(model_path, dataset, eval_mode, hr10, hr100, hr10_n, hr100_n):
    csv_file = 'benchmark_results_blue.csv'
...
if __name__ == "__main__":
    for folder, d_name, pkl in [('data_70_30/clothing_items_train_item_model', 'clothing_items_train', 'data/data_70_30/test_data_items.pkl'),
                                ('data_70_30/clothing_groups_train_group_model', 'clothing_groups_train', 'data/data_70_30/test_data_groups.pkl')]:
